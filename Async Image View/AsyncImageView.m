...
- (void)setImage:(UIImage *)image
{
    ...
    if(image!=nil)
    {
    AppDelegate *appdelegateObjects=(AppDelegate *)[UIApplication sharedApplication].delegate;
    //appdelegateObjects.IsImage=YES;
//        
//        appdelegateObjects.indexpath=self.mIndexPath;
       // [[NSNotificationCenter defaultCenter]
        // postNotificationName:@"showContentAfterLoadingImage"
        // object:self.mIndexPath];
    }
    super.image = image;
