...
- (void)setDefaultValues
{
    ...
    self.menuMonthTextFont = [UIFont fontWithName:@"Lato-BOLD" size:18.0];;
    ...
    [self setDayDotColorForAll:[UIColor colorWithRed:104./256. green:177./256. blue:71./256. alpha:1.]];
    [self setDayTextColorForAll:[UIColor lightGrayColor]];
